...
You can:
 ...
 - from "Recent log messages" event pages (admin/reports/event/EVENT_NUMBER) you can easily block or unblock IP
   and check status of this IP on [AbuseIPDB](https://www.abuseipdb.com).
...
an IP address and check status of this IP on [AbuseIPDB](https://www.abuseipdb.com) from the "Operation" links.
